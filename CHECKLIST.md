...
- [ ] **2.1** **Chat shell** + streaming markdown (riusa primitive agent-UI da `awesome-shadcn-ui`)
- [ ] **2.2** **Tool-call card**: render delle azioni dell'agente (bash, edit, search…)
- [ ] **2.3** **Approva/Rifiuta** modifiche e comandi (human-in-the-loop) + allow-list auto-approve
